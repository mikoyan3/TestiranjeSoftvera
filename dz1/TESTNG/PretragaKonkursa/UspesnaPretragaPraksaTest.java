 ...
 * @author Perovic
 */
public class UspesnaPretragaPraksaTest {
    public static String baseUrl="http://localhost/Projekat1/JobFair/login.php";
    public static WebDriver driver;
    public UspesnaPretragaPraksaTest() {
    }
    
    @Test
    public void pretraziPraksuChrome(){
        ...
        try{
            ...
            if(driver.findElement(By.linkText("Konkursi")).isDisplayed()){
                ...
                String poruka = "Praksa";
                String search = driver.findElement(By.id("teloPretragaKP")).getText();
                Assert.assertTrue((search.contains(poruka) && !search.contains("Posao")) || (search.contains("Ne postoji rezultat")));
            }
        } catch(Exception e){
    ...
    @Test
    public void pretraziPraksuFirefox(){
