...
public class Game extends Observable {
    ...
    public void setInterface(MockInterface m) {
    	mi = m;
    }
    public void setHelpMockito() {
    	if(mi.isHelpMock() == true) this.setHelp(true);
    	else this.setHelp(false);
    }
    public void setNumberMockito() {
    	this.setSelectedNumber(mi.getSelectedCandidateMock());
    }
    public boolean isPossibleYMockito() {
    	return mi.isPossibleY();
    }
    public boolean isPossibleXMockito() {
    	return mi.isPossibleX();
    }
    public boolean isPossibleBlockMockito() {
    	return mi.isPossibleBlock();
    }
    public boolean isNumberCandidateMockito() {
    	return isPossibleYMockito() && isPossibleXMockito() && isPossibleBlockMockito();
    }
    /**
    ...
    public void setTrueCheck(int x, int y) {
    	check[x][y] = true;
    }
    /**
