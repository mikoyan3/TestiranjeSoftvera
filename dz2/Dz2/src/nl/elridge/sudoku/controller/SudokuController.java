...
public class SudokuController implements MouseListener {
    ...
    public void mouseClicked(MouseEvent e) { event = "mouseClicked"; }
    public void mouseEntered(MouseEvent e) { event = "mouseEntered"; }
    public void mouseExited(MouseEvent e) { event = "mouseExited"; }
    public void mouseReleased(MouseEvent e) { event = "mouseReleased"; }
}